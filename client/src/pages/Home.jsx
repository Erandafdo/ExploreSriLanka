    ...
    <div style={{ 
      ...
      <main className="container hero-grid">
        ...
        >
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.25rem', maxWidth: '500px', lineHeight: 1.8, marginBottom: '2rem', margin: '0 auto 2rem' }}>
            Interact with our 3D map. Click on any district to explore its unique beauty, culture, and attractions.
          </p>
          <motion.div 
            animate={{ y: [0, 10, 0] }}
            transition={{ repeat: Infinity, duration: 2 }}
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', color: 'var(--accent)', fontWeight: 600, cursor: 'pointer' }}
      ...
      <style>{`
        @media (min-width: 992px) {
          .hero-content-wrapper { text-align: left !important; }
          .hero-content-wrapper p { margin-left: 0 !important; }
          .hero-content-wrapper div { justify-content: flex-start !important; }
        }
      `}</style>
        ...
        >
          <div style={{ textAlign: 'center', marginBottom: 'var(--spacing-lg)' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto' }}>
              Explore world-renowned destinations that every traveler must experience.
            </p>
          </div>
